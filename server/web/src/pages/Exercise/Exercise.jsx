...
class Exercise extends Component {
  ...
  loadReferenceVideo = async () => {
    ...
    referenceVideo.src = '/E_ID15_Es1.mp4' // files in the public directory are served at the root path
  ...
  loadReferenceJointPositions = async () => {
    try {
      const response = await fetch('/E_ID15_Es1.csv') // files in the public directory are served at the root path
